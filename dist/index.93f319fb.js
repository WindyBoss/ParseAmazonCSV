...
})({"idBuz":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "3496d11c93f319fb";
"use strict";
...
},{}],"i6fa4":[function(require,module,exports) {
...
var _firstTableSetPlugin = require("./firstTableSetPlugin");
var _btnSwitch = require("./style-components/btn-switch");
var _openModal = require("./style-components/open-modal");
...
const tableDOMelements = new _btnSwitch.DOMTableElementManagement({
    inputSelector: _refs.refsFirstGrid.fileInput,
    sendBtnSelector: _refs.refsFirstGrid.fileBtn,
    resetBtnSelector: _refs.refsFirstGrid.btnReset,
    containerSelector: _refs.refsFirstGrid.gridDiv,
    tableShowSelector: 'table-shown'
});
const modal = new _openModal.OpenModal();
tableDOMelements._blockElement(_refs.refsFirstGrid.fileBtn);
tableDOMelements._blockElement(_refs.refsFirstGrid.btnReset);
tableDOMelements._blockElement(_refs.refsSecondGrid.tableActiveBtn);
// /*------- Table Making --------------*/
function setFistTablePlugin() {
    const firstTable = new _firstTableSetPlugin.TableSet({
        container: _refs.refsFirstGrid.gridDiv,
        data: _uploadCSV.parsedata,
        columnFilterContainer: _refs.refsFirstGrid.columnFilterContainer,
        quickFilterId: '#quickFilter',
        columnTotal: _refs.refsFirstGrid.columnTotal
    });
    return firstTable;
}
function postTable() {
    ...
    try {
        ...
        _refs.refsFirstGrid.columnFilterContainer.addEventListener('click', removeColumn);
        _refs.refsFirstGrid.addRemovedRows.addEventListener('click', addDeletedRows);
    } catch (error) {
        console.log(error);
...
function allowBtn(e) {
    if (_refs.refsSecondGrid.tableActiveBtn.disabled) _uploadCSV.parseCsv.getCsv('dealCsv', {
        once: true
    });
    // loadingModal.showModal();
    if (e.target.value !== '') {
        tableDOMelements._switchOnElement(_refs.refsFirstGrid.fileBtn);
        setTimeout(()=>{
            _refs.refsFirstGrid.fileBtn.addEventListener('click', postTable);
        }, 500);
...
function addTable() {
    tableDOMelements._switchOnElement(_refs.refsSecondGrid.tableActiveBtn);
    _refs.refsSecondGrid.tableActiveBtn.addEventListener('click', showSecondTableBtn);
}
function clearFileInput() {
    tableDOMelements._clearInput();
    _refs.refsFirstGrid.fileInput.classList.add('is-hidden');
}
function switchOnResetBtn() {
    tableDOMelements._switchOnElement(_refs.refsFirstGrid.btnReset);
    _refs.refsFirstGrid.btnReset.addEventListener('click', tableReset);
}
function tableReset() {
    const tablePlugin = setFistTablePlugin();
    ...
    tableDOMelements._blockElement(_refs.refsFirstGrid.fileBtn);
    _refs.refsFirstGrid.fileInput.classList.remove('is-hidden');
}
function addDeletedRows() {
    const tablePlugin = setFistTablePlugin();
    tablePlugin._onAddRow();
}
/*------- Add EventListeners --------------*/ _refs.refsFirstGrid.fileInput.addEventListener('input', allowBtn);
_refs.refsFirstGrid.clearSelectedBtn.addEventListener('click', clearSelection);
_refs.refsFirstGrid.deleteSelectedBtn.addEventListener('click', deleteSelected);
_refs.refsFirstGrid.tableQuickFilterInput.addEventListener('input', _.debounce(quickFilter, 300));
_refs.refs.openModalBtn.addEventListener('click', setOpenModal);
function setOpenModal() {
    modal._openModal(_refs.refs.modalContainer);
}
...
function showSecondTableBtn() {
    tableDOMelements._showElement(_refs.refsSecondGrid.btnContainerTable);
    tableDOMelements._blockElement(_refs.refsSecondGrid.fileBtn);
    tableDOMelements._blockElement(_refs.refsSecondGrid.btnReset);
    tableDOMelements._blockElement(_refs.refsSecondGrid.tableActiveBtn);
}

},{"notiflix/build/notiflix-notify-aio":"heCpW","spin.js":"kKL8g","../scss/main.scss":"5b6JI","lodash":"1vR8I","./refs":"cfXjd","./style-components/spin":"aLrfe","./style-components/loading-modal":"edOxH","./uploadCSV":"ebRpn","./firstTableSetPlugin":"dL4BU","./style-components/btn-switch":"dyxwx","./style-components/open-modal":"cKnfa"}],"heCpW":[function(require,module,exports) {
...
},{}],"kKL8g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Spinner", ()=>Spinner1
);
...
var Spinner1 = function() {
    function Spinner(opts) {
        if (opts === void 0) opts = {
        };
        this.opts = __assign(__assign({
        }, defaults), opts);
    }
    /**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5b6JI":[function() {},{}],"1vR8I":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}],"aLrfe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CustomLoadingCellRenderer", ()=>CustomLoadingCellRenderer
);
parcelHelpers.export(exports, "spinnerOptions", ()=>spinnerOptions
);
var _spinJs = require("spin.js");
...
const tableSpinner = new _spinJs.Spinner(spinnerOptions).spin(tableSpinnerContainer);
...
},{"spin.js":"kKL8g","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"edOxH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "LoadingModal", ()=>LoadingModal
);
class LoadingModal {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ebRpn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "parsedata", ()=>parsedata
);
parcelHelpers.export(exports, "parseCsv", ()=>parseCsv
);
function uploadDealcsv() {
}
/*------ Method for read uploded csv file ------*/ uploadDealcsv.prototype.getCsv = function(inputId) {
    let input = document.getElementById(inputId);
    input.addEventListener('change', function() {
        if (this.files && this.files[0]) {
            for (let file of this.files)var myFile = file;
...
let parsedata = [];
/*------- Method for parse csv data and display --------------*/ uploadDealcsv.prototype.getParsecsvdata = function(data) {
    parsedata = [];
    let newLinebrk = data.split("\n");
    for(let i = 0; i < newLinebrk.length; i++)parsedata.push(newLinebrk[i].replace(',,', ', No Data,').split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/g));
    return newLinebrk;
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dL4BU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _notiflixNotifyAio = require("notiflix/build/notiflix-notify-aio");
var _spin = require("./style-components/spin");
// import myFooterValueGetter from './table-elements-plugin/footer';
        ...
        cellRendererParams: {
            innerRenderer: (params)=>{
                if (params.node.footer) {
                    ...
                    if (isRootLevel) return `<span class='total'>Total</span>`;
                    return `<span class='group-total'>Group Total ${params.value}</span>`;
                }
                return params.value;
            }
        }
...
class TableSet {
    constructor({ container , data , columnFilterContainer , quickFilterId , columnTotal ,  }){
        this._data = data;
        this._dataConverter = {
        };
        this._table = [];
    ...
    _setColumnFilter() {
        mainRow.tableReset();
        this._columnFilterContainer.innerHTML = '';
...
},{"./table-elements-plugin/mainRow":"dJaJI","./table-elements-plugin/table-cells":"kPN7M","./table-elements-plugin/cell/cell-converter":"7fWb7","notiflix/build/notiflix-notify-aio":"heCpW","./style-components/spin":"aLrfe","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dJaJI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MainTableRow", ()=>MainTableRow
);
var _numberColumn = require("./table-components/number-column");
var _numberColumnDefault = parcelHelpers.interopDefault(_numberColumn);
var _metrics = require("./table-components/metrics");
var _percentage = require("./table-components/percentage");
var _refs = require("../refs");
const tableParams1 = {
    marketingSales: 0,
    spend: 0,
...
class MainTableRow {
    ...
    makeColumnHeadLine() {
        ...
        for(let i = 0; i < this.headerValue.length; i++){
            ...
            if (_numberColumnDefault.default.includes(String(this.headerValue[i]).toLowerCase().trim())) {
            ...
            if (i < 1) headerAttributtes.aggFunc = this.firstColumnConclude;
            if (i > 6) {
                headerAttributtes.chartDataType = 'series';
                headerAttributtes.enablePivot = true;
            }
            if (i > 7) headerAttributtes.maxWidth = 180;
            ...
            } else if (_numberColumnDefault.default.includes(String(this.headerValue[i]).toLowerCase().trim())) headerAttributtes.filter = 'agTextColumnFilter';
    ...
    fieldNameConfig(str1) {
        let newStr = String(str1);
        newStr = newStr.replace('(USD)', '');
        newStr = newStr.replace('(EUR)', '');
        newStr = newStr.replace('(GBP)', '');
        newStr = newStr.replace('-', ' ');
...
function pasteTotal(tableParams) {
    _refs.refsFirstGrid.columnTotal.innerHTML = '';
    ...
    tableParams.forEach((param)=>{
        ...
        _refs.refsFirstGrid.columnTotal.insertAdjacentHTML('afterbegin', renderedParam);
    });
}
function makeTotalRow(keys, values) {
    const resultArray = [];
    keys.forEach((key, i)=>resultArray.push({
            key: key,
            value: values[i]
        })
    );
...
function clearTableParams() {
    tableParams1.marketingSales = 0;
    tableParams1.spend = 0;
    tableParams1.totalSales = 0;
    tableParams1.impression = 0;
    tableParams1.clicks = 0;
    tableParams1.sessions = 0;
    tableParams1.pageViews = 0;
    tableParams1.orders = 0;
    tableParams1.totalOrders = 0;
    tableParams1.marketingUnits = 0;
    tableParams1.totalUnits = 0;
    tableParams1.sum = 0;
    tableParams1.ntbOrders = 0;
    tableParams1.ntbSales = 0;
    tableParams1.buyBox = 0;
    tableParams1.rowNumber = 0;
    tableParams1.b2bUnitOrdered = 0;
    tableParams1.b2bTotalSales = 0;
    tableParams1.b2bTotalOrderedItem = 0;
    tableParams1.xraySales = 0;
    tableParams1.xrayRevenue = 0;
    tableParams1.fbaFees = 0;
    tableParams1.activeSellers = 0;
    tableParams1.rating = 0;
    tableParams1.reviewCount = 0;
    tableParams1.weight = 0;
    tableParams1.imagesNumber = 0;
    tableParams1.xrayPrice = 0;
    tableParams1.averageBSR = 0;
    tableParams1.viewableImpressions = 0;
    tableParams1.budget = 0;
    tableParams1.topOfsearchIs = 0;
    tableParams1.totalOfferCount = 0;
}
function ratioAggFunc(params) {
    tableParams1.rowNumber = params.values.length;
    setTimeout(()=>{
    ...
    if (_metrics.newMetricsSpliter.marketingSales.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.marketingSales += value;
        });
        return dataFormatter(tableParams1.marketingSales, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.totalSales.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.totalSales += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.totalSales, 1, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.totalSalesB2B.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.b2bTotalSales += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.b2bTotalSales, 1, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.totalUnitsB2B.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.b2bTotalOrderedItem += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.b2bTotalOrderedItem, 1, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.spend.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.spend += value;
        });
        return dataFormatter(tableParams1.spend, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.impression.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            tableParams1.impression += value;
        });
        return dataFormatter(tableParams1.impression, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.totalSessions.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.sessions += value;
        });
        return dataFormatter(tableParams1.sessions, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.totalPageViews.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.pageViews += value;
        });
        return dataFormatter(tableParams1.pageViews, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.orders.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.orders += value;
        });
        return dataFormatter(tableParams1.orders, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.marketingUnits.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.marketingUnits += value;
        });
        return dataFormatter(tableParams1.marketingUnits, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.totalUnits.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.totalUnits += value;
        });
        return dataFormatter(tableParams1.totalUnits, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.marketingClicks.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.clicks += value;
        });
        return dataFormatter(tableParams1.clicks, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.ntbOrders.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.ntbOrders += value;
        });
        return dataFormatter(tableParams1.ntbOrders, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.ntbSales.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.ntbSales += value;
        });
        return dataFormatter(tableParams1.ntbSales, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.totalUnitOrdered.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.totalOrders += value;
        });
        return dataFormatter(tableParams1.totalOrders, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.viewableImpressions.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.viewableImpressions += value;
        });
        return dataFormatter(tableParams1.viewableImpressions, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.vcpm.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.spend, tableParams1.viewableImpressions / 1000, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.averageBuyBox.includes(params.colDef.colId)) {
        // console.log(params.values);
        params.values.forEach((value)=>{
            const newValue = Number(value.replace('%', ''));
            if (isNaN(newValue)) return;
            tableParams1.buyBox += newValue;
        });
        return averageValueObject(tableParams1.buyBox, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.unitOrderedB2B.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.b2bUnitOrdered += value;
        });
        return dataFormatter(tableParams1.b2bUnitOrdered, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.revenue.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.xrayRevenue += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.xrayRevenue, 1, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.sales.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.xraySales += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.xraySales, 1, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.fbaFees.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.fbaFees += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.fbaFees, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.activeSellers.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.activeSellers += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.activeSellers, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.rating.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.rating += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.rating, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.reviewCount.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.reviewCount += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.reviewCount, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.weight.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.weight += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.weight, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.images.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.imagesNumber += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.imagesNumber, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.price.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.xrayPrice += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.xrayPrice, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.bsr.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.averageBSR += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.averageBSR, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.budget.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.budget += value;
        });
        return dataFormatter(tableParams1.budget, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.topOfsearchIs.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.topOfsearchIs += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.topOfsearchIs, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.averageOfferCount.includes(params.colDef.colId)) {
        params.values.forEach((value)=>{
            if (isNaN(value)) return;
            tableParams1.totalOfferCount += value;
        });
        return createValueObjectWithoutPercentage(tableParams1.totalOfferCount, tableParams1.rowNumber, params.colDef.headerName);
    }
    if (_metrics.newMetricsSpliter.acos.includes(params.colDef.colId)) return createValueObject(tableParams1.spend, tableParams1.marketingSales, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.roas.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.marketingSales, tableParams1.spend, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.ctr.includes(params.colDef.colId)) return createValueObject(tableParams1.clicks, tableParams1.impression, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.cr.includes(params.colDef.colId)) return createValueObject(tableParams1.orders, tableParams1.clicks, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.unitSessionPercentage.includes(params.colDef.colId)) return createValueObject(tableParams1.sessions, tableParams1.sessions, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.cpc.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.spend, tableParams1.clicks, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.NTBPercentageOrders.includes(params.colDef.colId)) return createValueObject(tableParams1.orders - tableParams1.ntbOrders, tableParams1.orders, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.NTBPercentageSales.includes(params.colDef.colId)) return createValueObject(tableParams1.marketingSales - tableParams1.ntbSales, tableParams1.marketingSales, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.sessionPercentage.includes(params.colDef.colId)) return createValueObject(tableParams1.sessions, tableParams1.sessions, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.totalPageViews.includes(params.colDef.colId)) return createValueObject(tableParams1.pageViews, 1, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.pageViewPercentage.includes(params.colDef.colId)) return createValueObject(tableParams1.pageViews, tableParams1.pageViews, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.unitSessionPercentageB2B.includes(params.colDef.colId)) return createValueObject(tableParams1.b2bUnitOrdered, tableParams1.sessions, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.orderItemSessionPercentage.includes(params.colDef.colId)) return createValueObject(tableParams1.totalUnits, tableParams1.sessions, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.orderItemSessionPercentageB2b.includes(params.colDef.colId)) return createValueObject(tableParams1.b2bTotalOrderedItem, tableParams1.sessions, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.averageSalesPerOrder.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.totalSales, tableParams1.totalUnits, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.averageSalesPerOrderB2B.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.b2bTotalSales, tableParams1.b2bTotalOrderedItem, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.averageUnitPerOrder.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.totalOrders, tableParams1.totalUnits, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.averageUnitPerOrderB2B.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.b2bUnitOrdered, tableParams1.b2bTotalOrderedItem, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.averageSellingPrice.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.totalSales, tableParams1.totalOrders, params.colDef.headerName);
    if (_metrics.newMetricsSpliter.averageSellingPriceB2B.includes(params.colDef.colId)) return createValueObjectWithoutPercentage(tableParams1.b2bTotalSales, tableParams1.b2bUnitOrdered, params.colDef.headerName);
    totalRowKeys = [];
    totalRowValues = [];
}
function createValueObject(param1, param2, paramDef) {
    ...
    if (param1 && param2) {
        ...
        if (forReturn !== 0) {
            if (totalRowKeys.includes(paramDef)) totalRowValues.splice(totalRowKeys.indexOf(paramDef), 1, forReturn);
            else {
...
function dataFormatter(sum, paramDef) {
    ...
    if (value !== 0) {
        if (totalRowKeys.includes(paramDef)) totalRowValues.splice(totalRowKeys.indexOf(paramDef), 1, value);
        else {
            totalRowKeys.push(paramDef);
...
function createValueObjectNoTotal(param1, param2) {
    let forReturn = 0;
    if (param1 && param2) forReturn = ratioFormatter(param1 / param2);
    else forReturn = 0;
    return {
        toString: ()=>forReturn
    };
...
function createValueObjectNoTotalWithoutPercentageNoTotal(param1, param2) {
    let forReturn = 0;
    if (param1 && param2) forReturn = Math.round(param1 / param2 * 100) / 100;
    else forReturn = 0;
    return {
        toString: ()=>forReturn
    };
...
function ratioValueGetter(params) {
    if (!params.node.group) {
        if (_metrics.newMetricsSpliter.marketingSales.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.sales);
        if (_metrics.newMetricsSpliter.totalSales.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.orderedProductSales);
        if (_metrics.newMetricsSpliter.totalSalesB2B.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.orderedProductSalesB2b);
        if (_metrics.newMetricsSpliter.totalUnitsB2B.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.totalOrderItemsB2b);
        if (_metrics.newMetricsSpliter.spend.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.spend);
        if (_metrics.newMetricsSpliter.impression.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.impressions);
        if (_metrics.newMetricsSpliter.totalSessions.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.sessions);
        if (_metrics.newMetricsSpliter.totalPageViews.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.pageViews);
        if (_metrics.newMetricsSpliter.orders.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.orders);
        if (_metrics.newMetricsSpliter.marketingUnits.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.marketingUnits);
        if (_metrics.newMetricsSpliter.totalUnits.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.totalOrderItems);
        if (_metrics.newMetricsSpliter.marketingClicks.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.clicks);
        if (_metrics.newMetricsSpliter.ntbOrders.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.ntbOrders);
        if (_metrics.newMetricsSpliter.ntbSales.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.ntbSales);
        if (_metrics.newMetricsSpliter.totalUnitOrdered.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.unitsOrdered);
        if (_metrics.newMetricsSpliter.averageBuyBox.includes(params.colDef.colId)) return params.data.featuredOfferBuyBoxPercentage;
        if (_metrics.newMetricsSpliter.unitOrderedB2B.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.unitsOrderedB2b);
        if (_metrics.newMetricsSpliter.revenue.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.xrayRevenue);
        if (_metrics.newMetricsSpliter.sales.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.xraySales);
        if (_metrics.newMetricsSpliter.fbaFees.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.fbaFees);
        if (_metrics.newMetricsSpliter.activeSellers.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.activeSellers);
        if (_metrics.newMetricsSpliter.rating.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.rating);
        if (_metrics.newMetricsSpliter.reviewCount.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.reviewCount);
        if (_metrics.newMetricsSpliter.weight.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.weight);
        if (_metrics.newMetricsSpliter.images.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.imagesNumber);
        if (_metrics.newMetricsSpliter.price.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.xrayPrice);
        if (_metrics.newMetricsSpliter.bsr.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.averageBSR);
        if (_metrics.newMetricsSpliter.acos.includes(params.colDef.colId)) return createValueObjectNoTotal(params.data.spend, params.data.sales);
        if (_metrics.newMetricsSpliter.roas.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.sales, params.data.spend);
        if (_metrics.newMetricsSpliter.ctr.includes(params.colDef.colId)) return createValueObjectNoTotal(params.data.clicks, params.data.impressions);
        if (_metrics.newMetricsSpliter.cr.includes(params.colDef.colId)) return createValueObjectNoTotal(params.data.orders, params.data.clicks);
        if (_metrics.newMetricsSpliter.unitSessionPercentage.includes(params.colDef.colId)) return params.data.unitSessionPercentage;
        if (_metrics.newMetricsSpliter.cpc.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.spend, params.data.clicks);
        if (_metrics.newMetricsSpliter.budget.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.budget);
        if (_metrics.newMetricsSpliter.NTBPercentageOrders.includes(params.colDef.colId)) return createValueObjectNoTotal(params.data.orders - params.data.ntbOrders, params.data.orders);
        if (_metrics.newMetricsSpliter.NTBPercentageSales.includes(params.colDef.colId)) return createValueObjectNoTotal(params.data.sales - params.data.ntbSales, params.data.sales);
        if (_metrics.newMetricsSpliter.sessionPercentage.includes(params.colDef.colId)) return params.data.sessionPercentage;
        if (_metrics.newMetricsSpliter.totalPageViews.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.pageViews);
        if (_metrics.newMetricsSpliter.pageViewPercentage.includes(params.colDef.colId)) return params.data.pageViewsPercentage;
        if (_metrics.newMetricsSpliter.unitSessionPercentageB2B.includes(params.colDef.colId)) return params.data.unitSessionPercentageB2b;
        if (_metrics.newMetricsSpliter.viewableImpressions.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.viewableImpressions);
        if (_metrics.newMetricsSpliter.vcpm.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.spend, params.data.viewableImpressions / 1000);
        if (_metrics.newMetricsSpliter.orderItemSessionPercentage.includes(params.colDef.colId)) return createValueObjectNoTotal(params.data.totalOrderItems, params.data.sessions);
        if (_metrics.newMetricsSpliter.orderItemSessionPercentageB2b.includes(params.colDef.colId)) return createValueObjectNoTotal(params.data.totalOrderItemsB2b, params.data.sessions);
        if (_metrics.newMetricsSpliter.averageOfferCount.includes(params.colDef.colId)) return dataFormatterNoTotal(params.data.averageOfferCount);
        if (_metrics.newMetricsSpliter.averageSalesPerOrder.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.orderedProductSales, params.data.totalOrderItems);
        if (_metrics.newMetricsSpliter.averageSalesPerOrderB2B.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.orderedProductSalesB2b, params.data.totalOrderItemsB2b);
        if (_metrics.newMetricsSpliter.averageUnitPerOrder.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.unitsOrdered, params.data.totalOrderItems);
        if (_metrics.newMetricsSpliter.averageUnitPerOrderB2B.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.unitsOrderedB2b, params.data.totalOrderItemsB2b);
        if (_metrics.newMetricsSpliter.averageSellingPrice.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.orderedProductSales, params.data.unitsOrdered);
        if (_metrics.newMetricsSpliter.averageSellingPriceB2B.includes(params.colDef.colId)) return createValueObjectNoTotalWithoutPercentageNoTotal(params.data.orderedProductSalesB2b, params.data.unitsOrderedB2b);
        if (_metrics.newMetricsSpliter.topOfsearchIs.includes(params.colDef.colId)) {
            let newParam = '';
            try {
                if (params.data.topofsearchIs.includes('%')) newParam = params.data.topofsearchIs.replace('%', '');
                else newParam = params.data.topofsearchIs;
                if (!isNaN(Number(newParam))) return averageDataFormatter(Number(newParam));
                else return stringFormatter(params.data.topofsearchIs);
            } catch (err) {
...
},{"./table-components/number-column":"054my","./table-components/metrics":"kPGTv","./table-components/percentage":"bkEgb","../refs":"cfXjd","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"054my":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = numberColumnType = [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kPGTv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "newMetricsSpliter", ()=>newMetricsSpliter
);
const newMetricsSpliter = {
    NTBPercentageOrders: [
        '%OfOrdersNtb'
    ],
    NTBPercentageSales: [
    ...
    percentageUnitOrdered: [
        'percentageunitsOrdered'
    ],
    price: [
        'price'
    ],
    ...
    roas: [
        'totalReturnOnAdvertisingSpendRoas',
        'roas'
    ],
    sessionPercentage: [
        'sessionPercentage'
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"bkEgb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kPN7M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SimpleRow", ()=>SimpleRow
);
var _percentage = require("./table-components/percentage");
class SimpleRow {
    constructor(){
        ...
        for(let i = 1; i < this.columnsValue.length; i++){
            ...
            for(let j = 0; j < this.columnsValue[i].length; j++){
                ...
                if (Number(isNaN(columnValue))) {
                    const cell = [
                        this.fieldNameConfig(this.columnName[j]),
                        String(columnValue), 
                    ];
                    row.push(cell);
                } else if (_percentage.percentage.includes(String(this.columnName[j]))) {
                    const cell = [
                        this.fieldNameConfig(this.columnName[j]),
                        Math.floor(columnValue * 10000) / 100, 
                    ];
                    row.push(cell);
                } else {
                    const cell = [
                        this.fieldNameConfig(this.columnName[j]),
                        Math.floor(columnValue * 100) / 100, 
                    ];
                    row.push(cell);
                }
            }
...
},{"./table-components/percentage":"bkEgb","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"7fWb7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MakeTableRow", ()=>MakeTableRow
);
class MakeTableRow {
    constructor({ data  }){
        this._data = data;
    ...
    _checkTheLetter(word) {
        let newWord = word;
        for (let letter of word)if (letter === 'â' || letter === 'Â' || letter === '' || letter === '¬' || letter === 'ï' || letter === '»' || letter === '¿' || letter === '"' || letter === '£' || letter === '$') {
            // console.log(letter);
            newWord = word.replace(letter, '');
            for (let letter3 of newWord)if (letter3 === 'â' || letter3 === 'Â' || letter3 === '' || letter3 === '¬' || letter3 === 'ï' || letter3 === '»' || letter3 === '¿' || letter3 === '"' || letter3 === '£' || letter3 === '$') newWord = newWord.replace(letter3, '');
        }
        newWord = this._splitValidation(newWord);
        for (let letter1 of newWord)if (letter1 === 'â' || letter1 === 'Â' || letter1 === '' || letter1 === '¬' || letter1 === 'ï' || letter1 === '»' || letter1 === '¿' || letter1 === '"' || letter1 === '£' || letter1 === '$' || // letter === '%' ||
        letter1 === 'Ã') newWord = newWord.replace(letter1, '');
        for (let letter2 of newWord){
            if (letter2 === '¤') newWord = newWord.replace(letter2, 'ä');
            if (letter2 === '¼') newWord = newWord.replace(letter2, 'ü');
            if (letter2 === '') newWord = newWord.replace(letter2, 'ß');
            if (letter2 === '¶') newWord = newWord.replace(letter2, 'ö');
        }
        return newWord;
    }
    ...
    _cellsConverter(cell) {
        if (isNaN(Number(cell))) return String(cell);
        return Number(cell);
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dyxwx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DOMTableElementManagement", ()=>DOMTableElementManagement
);
class DOMTableElementManagement {
    constructor({ inputSelector , sendBtnSelector , resetBtnSelector , containerSelector , tableShowSelector ,  }){
    ...
    _checkboxChecked(checkboxes, selector) {
        ...
        checkboxes.forEach((checkbox)=>{
            ...
            } else if (!checkbox.checked) checkbox.classList.add(selector);
        });
        return checkBoxId;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"cKnfa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["idBuz","i6fa4"], "i6fa4", "parcelRequired7c6")

//# sourceMappingURL=index.93f319fb.js.map
